...
class TestVisionAutofixSuite(unittest.TestCase):
    ...
    def test_26_docx_report_includes_ai_autofix_section(self):
        ...
        # Verify AI AutoFix and internal branches do NOT leak into client VAPT report
        self.assertNotIn("AI AutoFix Remediation Tracking", doc_text)
        self.assertNotIn("tracegate/fix/VULN-001", doc_text)
        self.assertNotIn("a1b2c3d4e5", doc_text)
        # Verify professional developer remediation and validation guidance ARE included
        self.assertIn("Recommended Technical Remediation", doc_text)
        self.assertIn("Developer Validation Guidance", doc_text)
