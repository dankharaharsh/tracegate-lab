...
class TestVaptReportImportSuite(unittest.TestCase):
    ...
    def test_report_generator_traceability_and_15_point_structure(self):
        ...
        # Under standalone VAPT report rules, internal fix branches and PRs MUST NOT leak into the client report
        v8_text = "\n".join(sections_by_heading["VULN-008: Critical Remote Code Execution"])
        self.assertNotIn("tracegate/fix/VULN-008", v8_text)
        self.assertNotIn("https://github.com/tracegate/repo/pull/8", v8_text)
        self.assertIn("Recommended Technical Remediation", v8_text)

        # VULN-001 section MUST NOT contain VULN-008 data or internal fix branch
        ...
        self.assertIn("Recommended Technical Remediation", v1_text)

        # Verify client-facing subsections present in generated document
        ...
        for letter, name in [
            ...
            ("L.", "Defense-in-Depth Architectural Hardening"),
